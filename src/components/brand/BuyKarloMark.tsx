...
export function BuyKarloMark({ className, title = "BuyKarlo" }: BuyKarloMarkProps) {
  ...
  const blueId = `buykarlo-blue-${uniqueId}`
  const orangeId = `buykarlo-orange-${uniqueId}`
  const shadowId = `buykarlo-shadow-${uniqueId}`
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={blueId} x1="30" y1="18" x2="104" y2="108" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1266FF" />
          <stop offset="1" stopColor="#1C16CF" />
        </linearGradient>
        <linearGradient id={orangeId} x1="26" y1="74" x2="82" y2="118" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FFB000" />
          <stop offset="1" stopColor="#FF7A00" />
        </linearGradient>
        <filter id={shadowId} x="8" y="6" width="112" height="116" filterUnits="userSpaceOnUse">
